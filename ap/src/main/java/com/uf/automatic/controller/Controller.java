...
//				}
				for (Enumeration e = configProperty.propertyNames(); e.hasMoreElements();) { 
					  ...
					  for(int i=0;i<10;i++) {
						  if(Integer.parseInt(array[i])==1)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#FFFF00\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==2)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#ADD8E6\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==3)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#F0FFFF\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==4)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#D2691E\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==5)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#00FFFF\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==6)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#8A2BE2\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==7)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#FFF8DC\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==8)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#DC143C\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==9)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#A52A2A\">"+Integer.parseInt(array[i])+"</td>";
						  if(Integer.parseInt(array[i])==10)temp+="<td align=\"center\" style=\"font-size: 16px;font-weight:bold;border: 1px solid black;background-color:#7FFF00\">"+Integer.parseInt(array[i])+"</td>";
